...
export class Backend implements backendInterface {
    ...
    async addProduct(arg0: string, arg1: bigint, arg2: string, arg3: ExternalBlob): Promise<string> {
        if (this.processError) {
            try {
    ...
    async checkout(arg0: string, arg1: string, arg2: string): Promise<string> {
        if (this.processError) {
            try {
    ...
    async updateProduct(arg0: string, arg1: string, arg2: bigint, arg3: string, arg4: ExternalBlob): Promise<void> {
        if (this.processError) {
            try {
